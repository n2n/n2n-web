...
class ResponseCacheStoreTest extends TestCase {
	...
	function testStore() {
		...
		$this->responseCacheStore->store(1, 'hostname', $path, [], ['char1' => 1], $responseCacheItem2, true);
		$this->responseCacheStore->store(1, 'hostname', $path, [], ['char2' => 1], $responseCacheItem1, true);
		$this->responseCacheStore->store(1, 'mirror', $path, [], [], $responseCacheItem2, false);
		$this->responseCacheStore->store(2, 'hostname', $path, [], [], $responseCacheItem3, false);
		$this->responseCacheStore->store(1, 'hostname', $path, [], [], $responseCacheItem4, false);
		...
		$this->assertEquals($responseCacheItem1, $this->responseCacheStore->get(
				1, 'hostname', $path, [], true, $this->today));
		...
		$this->assertEquals($responseCacheItem4, $this->responseCacheStore->get(
				1, 'hostname', $path, [], false, $this->today));
	...
	function testRemove() {
		...
		$responseCacheItem3 = new ResponseCacheItem('content three', 3, [], null, $this->future);
		$responseCacheItem4 = new ResponseCacheItem('content four', 4, [], null, $this->future);
		$responseCacheItem5 = new ResponseCacheItem('content five', 5, [], null, $this->future);
		$responseCacheItem6 = new ResponseCacheItem('content six', 6, [], null, $this->future);
		...
		$this->responseCacheStore->store(1, 'hostname', new Path(['path', 'part2']), [], [], $responseCacheItem1, true);
		$this->responseCacheStore->store(1, 'mirror', new Path(['path', 'part2']), [], ['char2' => 1], $responseCacheItem2, true);
		...
		$this->responseCacheStore->store(1, 'hostname', new Path(['path', 'part2']), ['q2' => 2, 'q1' => 1], ['char2' => 1], $responseCacheItem3, false);
		$this->responseCacheStore->store(1, 'hostname', new Path(['path', 'part2']), ['q1' => 1, 'q2' => 2], ['char1' => 1], $responseCacheItem3, false);
		$this->responseCacheStore->store(1, 'hostname', new Path(['path', 'part2']), ['q1' => 1], [], $responseCacheItem3, false);
		$this->responseCacheStore->store(1, 'hostname', new Path(['path', 'part2']), ['q2' => 1], [], $responseCacheItem3, false);
		$this->responseCacheStore->store(2, 'hostname', new Path(['path', 'part2']), [], ['char1' => 1], $responseCacheItem3, false);
		$this->responseCacheStore->store(2, 'hostname', new Path(['path', 'part4']), [], ['char2' => 1], $responseCacheItem4, false);
		$this->responseCacheStore->store(1, 'mirror', new Path(['path', 'part2']), [], [], $responseCacheItem5, false);
		$this->responseCacheStore->store(2, 'mirror', new Path(['path', 'part2']), [], [], $responseCacheItem6, false);
		...
		$this->responseCacheStore->remove(1, 'hostname', new Path(['path', 'part2']), ['q1' => 1], false);
		...
		$this->responseCacheStore->remove(1, 'hostname', new Path(['path', 'part2']), ['q2' => 2, 'q1' => 1], false);
		$this->assertCount(0, $localCacheStore->findAll(ResponseCacheStore::RESPONSE_NAME,
				['method' => 1, 'hostName' => 'hostname', 'query' => ['q1' => 1, 'q2' => 2]]));
		$this->assertCount(0, $localCacheStore->findAll(ResponseCacheStore::INDEX_NAME,
				['method' => 1, 'hostName' => 'hostname', 'query' => ['q1' => 1, 'q2' => 2]]));
		...
		$this->responseCacheStore->remove(1, 'hostname', new Path(['path', 'part2']), [], true);
		$this->assertCount(1, $sharedCacheStore->findAll(ResponseCacheStore::RESPONSE_NAME));
	...
	function testClearLocal() {
		...
		$this->responseCacheStore->store(1, 'hostname', new Path(['path', 'part2']), ['q2' => 2, 'q1' => 1], ['char2' => 1], $responseCacheItem3, false);
		$this->responseCacheStore->store(1, 'hostname', new Path(['path', 'part2']), ['q1' => 1, 'q2' => 2], ['char1' => 1], $responseCacheItem3, false);
		$this->responseCacheStore->store(1, 'hostname', new Path(['path', 'part2']), ['q1' => 1], ['char2' => 1], $responseCacheItem3, false);
		$this->responseCacheStore->store(1, 'hostname', new Path(['path', 'part2']), ['q2' => 1], ['char2' => 1], $responseCacheItem3, false);
		$this->responseCacheStore->store(2, 'hostname', new Path(['path', 'part2']), [], ['char1' => 1], $responseCacheItem3, false);
		$this->responseCacheStore->store(2, 'hostname', new Path(['path', 'part4']), [], ['char2' => 1], $responseCacheItem4, false);
		$this->responseCacheStore->store(1, 'mirror', new Path(['path', 'part2']), [], ['char1' => 1], $responseCacheItem5, false);
		$this->responseCacheStore->store(2, 'mirror', new Path(['path', 'part2']), [], ['char1' => 1], $responseCacheItem6, false);
		$this->assertCount(7, $localCacheStore->findAll(ResponseCacheStore::RESPONSE_NAME));
		$this->assertCount(8, $localCacheStore->findAll(ResponseCacheStore::INDEX_NAME));
	...
	function testIsExpired(): void {
		...
		$responseCacheItem1 = new ResponseCacheItem('content today one', 1, [], null, $this->today);
		$responseCacheItem2 = new ResponseCacheItem('content today two', 1, [], null, $this->today);
		...
		$this->assertNull($this->responseCacheStore->get(1, 'hostname', new Path(['path', 'part2']), [], false, $this->future));
		...
		$this->assertNull($this->responseCacheStore->get(2, 'hostname', new Path(['path', 'part2']), [], false, $this->future));
