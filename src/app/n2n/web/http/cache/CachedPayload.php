...
class CachedPayload extends BufferedPayload {
	...
	static function createFromSentPayload(Response $response, \DateTimeInterface $expireDateTime): CachedPayload {
		return new CachedPayload($response->getSentPayload()->getBufferedContents(), $response->getStatus(),
